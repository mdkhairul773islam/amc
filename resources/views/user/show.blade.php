                            ...
                            <div class="col-lg-5 col-md-6">
                                ...
                                <div class="profile_info">
                                    ...
                                    <ul>
                                        ...
                                        <li><strong>Department</strong>: {{$info->department->name}}</li>
                                        @endif
                                        <li><strong>Privilege</strong>: {{strFilter($info->privilege)}}</li>
                                    </ul>
                                </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select name="privilege" class="form-control" required>
                                                                ...
                                                                <option value="super" {{($info->privilege == 'super' ? 'selected' : '')}}>Admin</option>
                                                                @endif
