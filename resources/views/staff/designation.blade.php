                                ...
                                @foreach($results as $key => $row)
                                    <tr>
                                        ...
                                        <td class="operation_btn text-right print_hide">
                                            ...
                                            <a href="{{route('admin.staff.designation-destroy', $row->id)}}"
                ...
                <form action="{{route('admin.staff.designation-store')}}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="designation" class="form-control modal_form" autocomplete="off" required>
                        </div>
...
@push('footer-script')
    <script>
        function editData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.staff.designation-edit')}}",
                data: {id: id},
                dataType: 'json',
